...
enum class AppFontStyle(val key: String, val label: String) {
    ...
    SERIF("serif", "Serif"),
    MONO("mono", "Monoespaciada"),
    CURSIVE("cursive", "Manuscrita");

    companion object {
        fun fromKey(key: String?): AppFontStyle = entries.firstOrNull { it.key == key } ?: SANS
    }
}

private fun lightScheme(style: AgendaThemeStyle) = when (style) {
    AgendaThemeStyle.GRAPHITE_BLUE -> lightColorScheme(
        primary = Color(0xFF0B4F6C),
        secondary = Color(0xFF6B7C8F),
        tertiary = Color(0xFF263238),
        background = Color(0xFFF2F6F8),
        surface = Color.White,
        primaryContainer = Color(0xFFCDEAF5),
        secondaryContainer = Color(0xFFE0E6EB)
    )
    AgendaThemeStyle.SUNSET_GARDEN -> lightColorScheme(
        primary = Color(0xFF8A3B12),
        secondary = Color(0xFF2E6B3A),
        tertiary = Color(0xFFC99500),
        background = Color(0xFFFFF7E8),
        surface = Color(0xFFFFFCF5),
        primaryContainer = Color(0xFFFFD5C2),
        secondaryContainer = Color(0xFFD5EAD8)
    )
    AgendaThemeStyle.BOLD_CLASSIC -> lightColorScheme(
        primary = Color(0xFF003F88),
        secondary = Color(0xFFD14900),
    ...
    AgendaThemeStyle.MINT_LAVENDER -> lightColorScheme(
        ...
        secondaryContainer = Color(0xFFCFEFE9)
    )
    AgendaThemeStyle.PINK_BLUE -> lightColorScheme(
        primary = Color(0xFFB00063),
        secondary = Color(0xFF2367B1),
        tertiary = Color(0xFF6A3D7C),
        background = Color(0xFFFFF7FC),
        surface = Color.White,
        primaryContainer = Color(0xFFFFD5E8),
        secondaryContainer = Color(0xFFD7E9FF)
    )
    AgendaThemeStyle.GRAYSCALE -> lightColorScheme(
    ...
    AgendaThemeStyle.MULTICOLOR -> lightColorScheme(
        primary = Color(0xFF3F37C9),
        secondary = Color(0xFFE45756),
        tertiary = Color(0xFF2A9D65),
...
private fun darkScheme(style: AgendaThemeStyle) = when (style) {
    AgendaThemeStyle.GRAPHITE_BLUE -> darkColorScheme(
        primary = Color(0xFF75D1F0),
        secondary = Color(0xFFAFC4D6),
        tertiary = Color(0xFFCFD8DC),
        background = Color(0xFF0E1519),
        surface = Color(0xFF151E23)
    )
    AgendaThemeStyle.SUNSET_GARDEN -> darkColorScheme(
        primary = Color(0xFFFFA277),
        secondary = Color(0xFF8CD49A),
        tertiary = Color(0xFFFFD05A),
        background = Color(0xFF19130D),
        surface = Color(0xFF241B13)
    )
    AgendaThemeStyle.BOLD_CLASSIC -> darkColorScheme(
        primary = Color(0xFF8DC1FF),
        secondary = Color(0xFFFFA06A),
        tertiary = Color(0xFFFF8B98),
        background = Color(0xFF121417),
        surface = Color(0xFF1B1E22)
    )
    AgendaThemeStyle.MINT_LAVENDER -> darkColorScheme(
        primary = Color(0xFFCAB0F0),
        secondary = Color(0xFF65D9C6),
        tertiary = Color(0xFF75D7E5),
        background = Color(0xFF151219),
        surface = Color(0xFF211B27)
    )
    AgendaThemeStyle.PINK_BLUE -> darkColorScheme(
        primary = Color(0xFFFF9BCB),
        secondary = Color(0xFF9CC7FF),
        tertiary = Color(0xFFD7A6E8),
        background = Color(0xFF181216),
        surface = Color(0xFF241A21)
    )
    AgendaThemeStyle.GRAYSCALE -> darkColorScheme(
    ...
    AgendaThemeStyle.MULTICOLOR -> darkColorScheme(
        primary = Color(0xFFB8B3FF),
        secondary = Color(0xFFFFA39F),
        tertiary = Color(0xFF7CDBAA),
        background = Color(0xFF151319),
        surface = Color(0xFF201D25)
    )
}
...
fun agendaPaperColor(style: AgendaThemeStyle): Color = lightScheme(style).background
fun agendaRuleColor(style: AgendaThemeStyle): Color = lightScheme(style).outline.copy(alpha = .22f)
...
fun StudentTheme(
    ...
    fontScale: Float = 1f,
    fontStyle: AppFontStyle = AppFontStyle.SANS,
    content: @Composable () -> Unit
) {
    val colors = if (darkMode) darkScheme(style) else lightScheme(style)
    ...
    MaterialTheme(
        colorScheme = colors,
        typography = appTypography(fontScale.coerceIn(.85f, 1.35f), fontStyle),
        content = content
    )
}
